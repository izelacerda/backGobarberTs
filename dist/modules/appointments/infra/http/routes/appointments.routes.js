...
var _ProviderAppointmensController = _interopRequireDefault(require("../controllers/ProviderAppointmensController"));
...
const providerAppointmentsController = new _ProviderAppointmensController.default();
...
appointmentsRouter.post('/', (0, _celebrate.celebrate)({
  [_celebrate.Segments.BODY]: {
    provider_id: _celebrate.Joi.number().integer().required(),
